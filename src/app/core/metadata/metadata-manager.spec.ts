...
describe('Test Metadata manager', () => {
    ...
    it('Test MetaDataManager loadDataSourceForPlugin Annotations', fakeAsync(() => {
        ...
        const annotation_metadata_url = "https://api.example.com/notilusDossier/segments/flux?channel=CH1&startDate=2023-10-10 20:00:00&endDate=2023-10-10 20:30:00&format=AMALIA&clientId=annotations";
    ...
    it('Test MetaDataManager refreshDataSourceHeaders Annotation', () => {
        configData = require('tests/assets/config-mpe-with-annotations-info.json');
        // Jetons factices (payload jwt.io de démonstration, aucun décodage dans le code testé)
        ...
        const newToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.fake-refreshed-signature-for-tests';
