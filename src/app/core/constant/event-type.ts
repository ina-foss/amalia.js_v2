...
export enum PlayerEventType {
    ...
    /**
     * Invoked when frame-accurate segment loading is toggled (armed at slide-mode mouseup):
     * payload boolean, true while the next HLS fragment must carry accurate_seek=1
     * (consumed one-shot by the fragment loader on the landing fragment).
     */
    ACCURATE_SEEK_CHANGE = 'ina.player.accurateSeekChange',
    /**
     * Invoked when audio channel changed
     */
