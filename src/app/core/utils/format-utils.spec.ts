...
describe('Test Format utils', () => {
    ...
    it('Test convertFormattedTcToSeconds test frames', () => {
        const defaultFps = DEFAULT.FPS;
        const customFps = 60;
        expect(FormatUtils.convertFormattedTcToSeconds('00:00:02:01', 'f', defaultFps)).toEqual(1 + (1 / defaultFps * 26));
        expect(FormatUtils.convertFormattedTcToSeconds('00:00:01:00', 'f', defaultFps)).toEqual(1);
        expect(FormatUtils.convertFormattedTcToSeconds('01:45:25:01', 'f', defaultFps)).toEqual(3600 + 2700 + 25 + (1 / defaultFps));
        expect(FormatUtils.convertFormattedTcToSeconds('01:45:25:02', 'f', defaultFps)).toEqual(3600 + 2700 + 25 + (1 / defaultFps * 2));
        expect(FormatUtils.convertFormattedTcToSeconds('01:45:25:10', 'f', defaultFps)).toEqual(3600 + 2700 + 25 + (0.04 * 10));
        expect(FormatUtils.convertFormattedTcToSeconds('01:45:25:20', 'f', defaultFps)).toEqual(3600 + 2700 + 25 + (0.04 * 20));
        expect(FormatUtils.convertFormattedTcToSeconds('01:45:25:23', 'f', defaultFps)).toEqual(3600 + 2700 + 25 + (0.04 * 23));
        expect(FormatUtils.convertFormattedTcToSeconds('01:45:26:00', 'f', defaultFps)).toEqual(3600 + 2700 + 25 + (0.04 * 25));
        expect(FormatUtils.convertFormattedTcToSeconds('01:45:27:00', 'f', defaultFps)).toEqual(3600 + 2700 + 25 + (0.04 * 50));
        expect(FormatUtils.convertFormattedTcToSeconds('01:45:27:01', 'f', defaultFps)).toEqual(3600 + 2700 + 25 + (0.04 * 51));
        expect(FormatUtils.convertFormattedTcToSeconds('01:28:08:01', 'f', customFps)).toEqual(3600 + (28 * 60) + 8 + (1 / customFps));
        expect(FormatUtils.convertFormattedTcToSeconds('01:28:08:02', 'f', customFps)).toEqual(3600 + (28 * 60) + 8 + (1 / customFps * 2));
        expect(FormatUtils.convertFormattedTcToSeconds('01:28:08:10', 'f', customFps)).toEqual(3600 + (28 * 60) + 8 + (1 / customFps * 10));
        expect(FormatUtils.convertFormattedTcToSeconds('01:28:08:20', 'f', customFps)).toEqual(3600 + (28 * 60) + 8 + (1 / customFps * 20));
        expect(FormatUtils.convertFormattedTcToSeconds('01:28:08:23', 'f', customFps)).toEqual(3600 + (28 * 60) + 8 + (1 / customFps * 23));
        expect(FormatUtils.convertFormattedTcToSeconds('01:28:08:25', 'f', customFps)).toEqual(3600 + (28 * 60) + 8 + (1 / customFps * 25));
        expect(FormatUtils.convertFormattedTcToSeconds('01:28:08:50', 'f', customFps)).toEqual(3600 + (28 * 60) + 8 + (1 / customFps * 50));
        expect(FormatUtils.convertFormattedTcToSeconds('01:28:09:00', 'f', customFps)).toEqual(3600 + (28 * 60) + 8 + (1 / customFps * 60));
        expect(FormatUtils.convertFormattedTcToSeconds('01:28:09:01', 'f', customFps)).toEqual(3600 + (28 * 60) + 8 + (1 / customFps * 61));

        expect(FormatUtils.convertFormattedTcToSeconds('01:00:00', 's')).toEqual(3600);
        expect(FormatUtils.convertFormattedTcToSeconds('02:45:01', 's')).toBeCloseTo(3600 * 2 + 2700 + 1.21,0);
