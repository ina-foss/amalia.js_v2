...
const buildMediaPlayerElement = (
    component: HistogramPluginComponent,
    logger: DefaultLogger,
    httpClient: HttpClient,
    fakeMedia: FakeMediaElement,
): MediaPlayerElement => {
...
describe("HistogramPluginComponent (wavesurfer + MetadataManager)", () => {
    ...
    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [HttpClientTestingModule, HistogramPluginComponent],
    ...
    it("should invert interaction time when the player is in reverseMode", () => {
        ...
        component.handleMetadataLoaded();
        const interactionHandler = fakeWavesurfer.on.calls.allArgs().find((args) => args[0] === "interaction")![1] as (
            t: number,
        ) => void;
