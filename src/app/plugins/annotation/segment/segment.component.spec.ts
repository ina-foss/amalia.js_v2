...
describe("SegmentComponent", () => {
    ...
    beforeEach(async () => {
        // Depuis la conversion standalone, SegmentComponent importe ToastComponent : le
        // p-toast PrimeNG est réellement instancié et s'abonne aux observers du MessageService.
        ...
        await TestBed.configureTestingModule({
            imports: [FormsModule, AutoCompleteModule, ChipModule, TooltipModule, SegmentComponent, TcFormatPipe],
            providers: [
    ...
    describe("Categories Editing", () => {
        ...
        it("should ignore blur when flag is set", fakeAsync(() => {
            ...
            component.onCategoriesMouseDown({
                target: { closest: () => ({ classList: { contains: () => true } }) },
            } as any);
