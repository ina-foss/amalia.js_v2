    ...
    getJsonDataFromAnnotations = (): ExportColumnsHeader[] => {
        return this.segmentsInfo.subLocalisations.map((localisation) => {
            ...
            const row: any = {
                ...
                // Non-hover : le lien exporté doit rester en grande taille (previewWidth), pas en vignette de survol
                "Lien de l\'imagette": this.mediaPlayerElement?.getThumbnailUrl(tcThumbnail),
