        ...
        dataSources: [
            {
                ...
                headers: ["Authorization: Bearer ", "Accept: application/x-msgpack"],
                plugin: "timelines",
            },
            {
...
describe("AnnotationPluginComponent", () => {
    ...
    beforeEach(async () => {
        await TestBed.configureTestingModule({
            ...
            imports: [ButtonModule, ConfirmDialogModule, AnnotationPluginComponent],
        ...
        component.segmentsInfo.subLocalisations = [
            {
                ...
                data: {
                    ...
                    instanceTitle: "Claude Monet l\'éternel",
                },
                tc: 0,
                tcIn: 600,
                tcOut: 600,
                ...
                description:
                    "\"Impression, soleil levant\" est sans doute le tableau le plus connu de Claude Monet, mais aussi du mouvement impressionniste, puisqu'il est celui qui lui a donné son nom. Peint en 1872-73, il tient une place importante dans l'Histoire de l'Art et recèle de nombreux secrets.",
            },
        ];
            ...
            dataSources: [
                {
                    ...
                    headers: ["Authorization: ", "Accept: application/x-msgpack"],
                    plugin: "transcription-vrbs_part",
                },
                {
        ...
        const expectedJsonData: ExportColumnsHeader[] = [
            {
                ...
                "Titre de l'instance": "Claude Monet l\'éternel",
            },
        ];
...
describe("AnnotationPluginComponent ManageSegments", () => {
    ...
    it("should clone a segment", fakeAsync(() => {
        const segmentToBeCloned = component.segmentsInfo.subLocalisations.find(
            (segment) => segment.id === "003000pgbg2x",
        );
        ...
        let param: any = {
            index: component.segmentsInfo.subLocalisations.indexOf(event.payload) + 1,
            sourceSegment: event.payload,
        };
        ...
        expect(spyOnDisplayEventResponseStatus).toHaveBeenCalledWith({
            event: event_of_cloned,
            noSuccessSnackBar: false,
        });
    ...
    it("should remove a segment with confirm", fakeAsync(() => {
        const segmentToBeRemoved = component.segmentsInfo.subLocalisations.find(
            (segment) => segment.id === "003001388lb3",
        );
        const event: any = {
            type: "remove",
        ...
        const spyOnunselectAllSegments = spyOn(component, "unselectAllSegments").and.callThrough();
        const spyOnRemoveSegmentFromSegmentsInfo = spyOn(
            component as any,
            "removeSegmentFromSegmentsInfo",
        ).and.callThrough();
        const spyOnManageEventResponseStatus = spyOn(component, "manageEventResponseStatus").and.callThrough();
        const spyOnDisplayEventResponseStatus = spyOn(component, "displayEventResponseStatus").and.callThrough();
        const spyOnDisplaySnackBar = spyOn(component, "displaySnackBar").and.callThrough();
        ...
        const spans = fixture.debugElement.queryAll(
            (el) =>
                el.nativeElement.tagName.toLowerCase() === "span" &&
    ...
    it("should update a thumbnail", fakeAsync(() => {
        const segmentToUpdateThumbnail = component.segmentsInfo.subLocalisations.find(
            (segment) => segment.id === "0030019jogtw",
        );
        const event: any = {
    ...
    it("should play the media", () => {
        const segmentToPlay: AnnotationLocalisation = component.segmentsInfo.subLocalisations.find(
        ...
        const segmentToPlayCard = fixture.debugElement.query(
            (el) =>
                el.nativeElement.tagName.toLowerCase() === "p-card" &&
                el.nativeElement.classList.contains("segment-selected"),
        );
        const playButton = segmentToPlayCard.query(
            (el) =>
                el.nativeElement.tagName.toLowerCase() === "svg" &&
                el.nativeElement.classList.contains("amalia-svg-blue-play-size"),
        );

        const spyOnManageSegment = spyOn(component, "manageSegment").and.callThrough();
        const spyOnGetDuration = spyOn(component.mediaPlayerElement.getMediaPlayer(), "getDuration").and.returnValue(
            600,
        );
    ...
    it("should init segment data", fakeAsync(() => {
        fixture.detectChanges();
        const button_AjouterUnSegment = fixture.debugElement.query(
            (el) =>
                el.nativeElement.tagName.toLowerCase() === "span" &&
                el.nativeElement.classList.contains("p-button-label") &&
    ...
    it("should emit OPEN_NOTILUS_MATERIAL when manageSegment receives openNotilusMaterial", () => {
        ...
        const segmentToOpen =
            component.segmentsInfo.subLocalisations.find((seg) => seg.id === "003000ai0qgw") ??
