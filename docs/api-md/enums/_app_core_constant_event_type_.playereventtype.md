[Amalia](../README.md) › [Globals](../globals.md) › ["app/core/constant/event-type"](../modules/_app_core_constant_event_type_.md) › [PlayerEventType](_app_core_constant_event_type_.playereventtype.md)
...
* [ASPECT_RATIO_CHANGE](_app_core_constant_event_type_.playereventtype.md#aspect_ratio_change)
* [AUDIO_CHANNEL_CHANGE](_app_core_constant_event_type_.playereventtype.md#audio_channel_change)
* [BEGIN_DATA_CHANGE](_app_core_constant_event_type_.playereventtype.md#begin_data_change)
* [BIND_METADATA](_app_core_constant_event_type_.playereventtype.md#bind_metadata)
* [CAST_PAUSED](_app_core_constant_event_type_.playereventtype.md#cast_paused)
* [CAST_PLAYING](_app_core_constant_event_type_.playereventtype.md#cast_playing)
* [DATA_CHANGE](_app_core_constant_event_type_.playereventtype.md#data_change)
* [DURATION_CHANGE](_app_core_constant_event_type_.playereventtype.md#duration_change)
* [ENDED](_app_core_constant_event_type_.playereventtype.md#ended)
* [END_DATA_CHANGE](_app_core_constant_event_type_.playereventtype.md#end_data_change)
* [ERROR](_app_core_constant_event_type_.playereventtype.md#error)
* [FULLSCREEN_STATE_CHANGE](_app_core_constant_event_type_.playereventtype.md#fullscreen_state_change)
* [IMAGE_CAPTURE](_app_core_constant_event_type_.playereventtype.md#image_capture)
* [INIT](_app_core_constant_event_type_.playereventtype.md#init)
* [METADATA_LOADED](_app_core_constant_event_type_.playereventtype.md#metadata_loaded)
* [MUTE](_app_core_constant_event_type_.playereventtype.md#mute)
* [PAUSED](_app_core_constant_event_type_.playereventtype.md#paused)
* [PLAYBACK_RATE_CHANGE](_app_core_constant_event_type_.playereventtype.md#playback_rate_change)
* [PLAYER_MOUSE_ENTER](_app_core_constant_event_type_.playereventtype.md#player_mouse_enter)
* [PLAYER_MOUSE_LEAVE](_app_core_constant_event_type_.playereventtype.md#player_mouse_leave)
* [PLAYING](_app_core_constant_event_type_.playereventtype.md#playing)
* [PLUGIN_ERROR](_app_core_constant_event_type_.playereventtype.md#plugin_error)
* [POSITION_SUBTITLE_CHANGE](_app_core_constant_event_type_.playereventtype.md#position_subtitle_change)
* [SEEKED](_app_core_constant_event_type_.playereventtype.md#seeked)
* [SEEKING](_app_core_constant_event_type_.playereventtype.md#seeking)
* [SELECTED_ITEMS_CHANGE](_app_core_constant_event_type_.playereventtype.md#selected_items_change)
* [SELECTED_METADATA_CHANGE](_app_core_constant_event_type_.playereventtype.md#selected_metadata_change)
* [STARTED](_app_core_constant_event_type_.playereventtype.md#started)
* [START_SEEKING](_app_core_constant_event_type_.playereventtype.md#start_seeking)
* [STOP_SEEKING](_app_core_constant_event_type_.playereventtype.md#stop_seeking)
* [TIME_CHANGE](_app_core_constant_event_type_.playereventtype.md#time_change)
* [UNBIND_METADATA](_app_core_constant_event_type_.playereventtype.md#unbind_metadata)
* [UN_MUTE](_app_core_constant_event_type_.playereventtype.md#un_mute)
* [VOLUME_CHANGE](_app_core_constant_event_type_.playereventtype.md#volume_change)
* [ZOOM_RANGE_CHANGE](_app_core_constant_event_type_.playereventtype.md#zoom_range_change)
...
Defined in src/app/core/constant/event-type.ts:12
