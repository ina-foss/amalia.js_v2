 ...
 *
 * Pourquoi : certains samples pointent leurs médias et leurs vignettes sur des hôtes
 * d'exemple injoignables et `samples/medias/` est volontairement vide. Sans accès à ces
 * hôtes, les pages principales ne chargent pas de média et ne sont pas déroulables en l'état.
 *
